      ...
      {[
        ...
        <motion.div
          ...
          <Button
            ...
            size="icon"
            className={cn(
              "rounded-sm w-auto cursor-pointer px-2 py-1 h-7 backdrop-blur-sm border hover:border-zinc-600 dark:hover:border-zinc-500 bg-transparent dark:bg-transparent",
